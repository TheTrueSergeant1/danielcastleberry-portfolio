...
const ProjectMediaServer = () => (
  <ProjectLayout title="Secure Media Architecture" date="December 2025">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <BentoCard title="Project Overview" className="md:col-span-2">
        <p className="text-lg leading-relaxed text-neutral-300 mb-4">
          Created and deployed a self-hosted media streaming environment. While the primary use case is media delivery via Jellyfin, the core objective was to build a 
         ...
         <div className="space-y-4">
            <div className="bg-white/5 p-4 rounded-xl border-l-2 border-cyber-accent">
                ...
                <p className="text-sm text-neutral-400 mt-1">
                    Eliminated the need for port forwarding. Implemented Tailscale to create a secure, encrypted peer-to-peer mesh network, ensuring data in transit is authenticated and accessible only to trusted nodes.
                </p>
            </div>
         </div>
      </BentoCard>
